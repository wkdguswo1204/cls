...
<body>
	...
	<div class="w3-third w3-container w3-card-4" id="msgWin" style="display: none;">
		<h2 class="w3-col m4" style="height: 250px;" id="msg"></h2>
		<h2 class="w3-col m8" style="height: 250px;"> 님은 이미 로그인 했습니다.</h2>
	</div>
